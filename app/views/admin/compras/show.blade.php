    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div class="input-group">
                ...
                <span class="form-control" >{{ $compra->num_factura }}</span>
            </div>

            <div class="input-group">
                <span class="input-group-addon" >N° Cheque</span>
                <span class="form-control" >{{ $compra->num_cheque }}</span>
            </div>

            <div class="input-group">
                <span class="input-group-addon" >Banco</span>
                <span class="form-control" >{{ $compra->banco->nombre }}</span>
            </div>
